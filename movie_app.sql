...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2022 at 02:30 PM
...
('Pushpa', '2021-12-17', 0, 'Action/Drama', 34, 'https://www.filmibeat.com/img/popcorn/movie_posters/pushpa-20200408090657-18075.jpg', 'Telugu'),
('Bahubali - 2', '2017-04-28', 0, 'Action/Drama', 35, 'https://upload.wikimedia.org/wikipedia/en/9/93/Baahubali_2_The_Conclusion_poster.jpg', 'Telugu');
...
(27, 1, 'reddy@gmail.com', 0, 8, 'good movie'),
(28, 2, 'reddy@gmail.com', 0, 7, 'ok movie'),
(29, 9, 'reddy@gmail.com', 0, 7, 'good movie'),
(30, 10, 'reddy@gmail.com', 0, 9, 'excellent movie'),
(31, 33, 'reddy@gmail.com', 0, 6, 'average movie'),
(32, 35, 'admin@gmail.com', 0, 9, 'excellent');
...
--
ALTER TABLE `movie`
  MODIFY `sl` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `review`
--
ALTER TABLE `review`
  MODIFY `sl` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
